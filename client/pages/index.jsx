...
const style = {
  // changed h-screen && w-screen to 100%
  wrapper: `flex justify-center min-h-screen w-100% select-none bg-[#15202b] text-white`,
...
export default function Home() {
  ...
  const error = (
    <div className={style.loginContainer}>
      <Image src={errorImg} height={250} width={200} />
      <div className={style.loginContent}>
